...
Gbi.CLR_ON_CVG = 0x80
Gbi.CVG_DST_CLAMP = 0
Gbi.CVG_DST_WRAP = 0x100
Gbi.CVG_DST_FULL = 0x200
Gbi.CVG_DST_SAVE = 0x300
Gbi.ZMODE_OPA = 0
Gbi.ZMODE_INTER = 0x400
Gbi.ZMODE_XLU = 0x800
Gbi.ZMODE_DEC = 0xc00
Gbi.CVG_X_ALPHA = 0x1000
Gbi.ALPHA_CVG_SEL = 0x2000
Gbi.FORCE_BL = 0x4000
Gbi.TEX_EDGE = 0x0000 -- used to be 0x8000

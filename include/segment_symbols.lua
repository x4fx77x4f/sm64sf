local function DECLARE_SEGMENT(name)
	_G['_'..name..'SegmentRomStart'] = {}
	_G['_'..name..'SegmentRomEnd'] = {}
end
local function DECLARE_ACTOR_SEGMENT(name)
	DECLARE_SEGMENT(name..'_mio0')
	DECLARE_SEGMENT(name..'_geo')
end
local function DECLARE_LEVEL_SEGMENT(name)

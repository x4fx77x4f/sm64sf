-- The equivalent of this file in n64decomp/sm64 is 'levels/intro/script.c'
-- The equivalent of this file in sm64js is 'src/levels/intro/script.js'
...
level_intro_splash_screen = {
	...
	SLEEP(--[[frames]] 75),
	TRANSITION(--[[transType]] WARP_TRANSITION_FADE_INTO_COLOR, --[[time]] 16, --[[color]] 0x00, 31, 0x00), -- TODO: revert
	SLEEP(--[[frames]] 16),
	CMD2A(--[[unk2]] 1),
	CLEAR_LEVEL(),
	SLEEP(--[[frames]] 2),
